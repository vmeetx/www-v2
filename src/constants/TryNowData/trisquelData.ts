export const trisquelData = {
  ...
  images: [
    {
      src: 'assets/TryNowImages/trisquel.webp',
      alt: 'Trisquel Sugar Blocks 1',
    },
    {
      src: 'assets/TryNowImages/trisquel2.webp',
...
export const trisquelLogoCards = [
  {
    ...
    buttons: [
      {
        text: 'Download: Trisquel Sugar TOAST',
        link: 'https://trisquel.info/en/download',
      },
    ],
  },
  {
    logo: 'assets/TryMoreSvgs/trisquel-community.svg',
    title: 'Get community support for Trisquel',
    description: [
      'There is no paid support for Trisquel. Go to the community forum for assistance.',
      'Multi-lingual: Forums are supported in English, Spanish, French, Italian, Galego, and German.',
    ],
    buttons: [
      {
        text: 'Explore community forums',
        link: 'https://trisquel.info/en/forum',
      },
    ],
  },
  {
    logo: 'assets/TryMoreSvgs/trisquel-documentation.svg',
    title: 'Read the documentation',
    description: [
      'Learn more about what makes Trisquel different.',
      'Read about Trisquel’s commitment to accessibility.',
      'Read about all the different ways that you can get community help for Trisquel.',
      'Read about how you can get involved.',
    ],
    buttons: [
      {
        text: 'Explore Sugar Labs’s documentation',
        link: 'https://wiki.sugarlabs.org/go/Trisquel_On_A_Sugar_Toast',
      },
    ],
  },
];

export const trisquelSections = [
  {
