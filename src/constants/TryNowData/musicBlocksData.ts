export const musicBlocksData = {
  ...
  quote: '“All musicians are subconsciously mathematicians” – Thelonious Monk, jazz pianist and composer',
  description:
...
export const musicBlocksSections = [
  {
    title: 'Using Music Blocks',
    content:
