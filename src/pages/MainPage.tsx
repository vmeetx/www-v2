              ...
              <div className="flex flex-col lg:flex-row gap-12">
                ...
                <div className="lg:w-1/4">
                  <h1 className="text-5xl font-bold mb-4 leading-tight">
                    <span className="text-black font-Caveat text-8xl">
                      What{' '}
                    </span>
                    <div
                      className="text-transparent bg-clip-text bg-gradient-to-r 
                  ...
                  <p className="text-gray-600 text-2xl leading-relaxed font-Roboto">
                    ...
                    . Here are some of the statistics we are tracking
                  </p>
                </div>
                ...
                <div className="container mx-auto p-4 max-w-7xl">
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                   ...
                   transition-all duration-500 ease-out"
                    >
                      <h3 className="text-gray-700 text-2xl font-medium mb-4 font-AnonymousPro">
                        Kids whone lives have been enriched by using the Sugar
                        Learning Platform.
                      </h3>
                   ...
                   transition-all duration-500 ease-out"
                    >
                      <h3 className="text-gray-700 text-lg font-medium mb-2 font-AnonymousPro">
                        Projects for teaching and learning created bay Sugar
                        Labs students and teachers.
                      </h3>
                   ...
                   transition-all duration-500 ease-out"
                    >
                      <h3 className="text-gray-700 text-lg font-medium mb-2 font-AnonymousPro">
                        Languages our educational software has been translated
                        into
                      </h3>
                   ...
                   transition-all duration-500 ease-out"
                    >
                      <h3 className="text-gray-700 text-lg font-medium mb-2 font-AnonymousPro">
                        Mentors helping youth learn in program like Google
                        Code-In (GCI) and Google Summer of Code
                      </h3>
                      <div className="text-6xl font-bold bg-gradient-to-r from-red-600 to-red-700 bg-clip-text text-transparent font-Caveat">
                        55+
                      </div>
