  ...
  return (
    <section className="max-w-7xl mx-auto py-20 px-6 bg-white">
          ...
          >
            ...
            >
              <img
                ...
                className="w-full h-full object-cover object-center"
              />
              <div className={`absolute inset-0 opacity-10 bg-gradient-to-br ${stat.gradient}`}></div>
            </motion.div>
            <div className="p-6">
              ...
              <div className={`w-24 h-1 bg-gradient-to-r ${stat.gradient} opacity-50 rounded-full mt-2`}></div>
            </div>
          </motion.div>
        ))}
      </motion.div>
      ...
      <motion.div 
        ...
        viewport={{ once: true }}
      >
        <h2 className="text-4xl font-bold text-gray-800 mb-6">Join us and make a difference</h2>
        <p className="text-gray-600 max-w-2xl mx-auto mb-10">
          These numbers represent more than statistics - they represent lives changed through 
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 max-w-6xl mx-auto">
          {statisticsData.map((stat, index) => (
            ...
            >
              <span className={`font-bold text-transparent bg-clip-text bg-gradient-to-r ${stat.gradient} text-xl md:text-2xl`}>
                {stat.value}
              </span>
